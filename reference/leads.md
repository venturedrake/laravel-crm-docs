...
Leads represent potential business opportunities that have not yet been qualified. A lead is typically the first point of contact in the sales pipeline, and can be associated with a [Person](/reference/people), [Organisation](/reference/organisations), or both. Once qualified, a lead can be converted into a [Deal](/reference/deals).
