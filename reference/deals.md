...
Deals represent qualified business opportunities with an estimated value and expected close date. Deals are typically created from converted [Leads](/reference/leads) and can progress through pipeline stages. Deals can have associated [Products](/reference/products), and can generate [Quotes](/reference/quotes).
