...
People represent individual contacts in the CRM. A person can belong to an [Organisation](/reference/organisations), be associated with [Leads](/reference/leads) and [Deals](/reference/deals), and become a [Customer](/reference/customers) via the polymorphic Client model. Personal fields support optional encryption for privacy.
