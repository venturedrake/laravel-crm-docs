...
Quotes represent formal proposals sent to clients with pricing and terms. A quote can be created from a [Deal](/reference/deals) and, once accepted, can be converted into an [Order](/reference/orders). Quotes progress through pipeline stages and track acceptance/rejection status.
