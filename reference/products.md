...
Products represent goods or services that can be sold. Products can have multiple price points (per currency), variations, and belong to [Product Categories](/reference/product-categories). Products are referenced as line items on [Deals](/reference/deals), [Quotes](/reference/quotes), [Orders](/reference/orders), and [Invoices](/reference/invoices).
