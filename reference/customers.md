...
Customers (internally called "Clients") represent the polymorphic bridge between a [Person](/reference/people) or [Organisation](/reference/organisations) and their role as a customer. This allows both people and organisations to be treated uniformly as customers throughout the system — on [Leads](/reference/leads), [Deals](/reference/deals), [Orders](/reference/orders), etc.
