...
Permissions extend [Spatie Permission](https://spatie.be/docs/laravel-permission) to provide granular access control within the CRM. CRM-specific permissions are distinguished via the `crm_permission` flag and are assigned to [Roles](/reference/roles).
