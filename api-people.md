...
| Verb | Path | Action |
|---|---|---|
| `GET` | `/crm/api/v2/people` | List (paginated). |
| `POST` | `/crm/api/v2/people` | Create. |
| `GET` | `/crm/api/v2/people/{uuid}` | Show. |
| `PUT` | `/crm/api/v2/people/{uuid}` | Update. |
| `DELETE` | `/crm/api/v2/people/{uuid}` | Soft-delete. |
