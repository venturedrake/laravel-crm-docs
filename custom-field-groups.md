...
Custom field groups organise [Custom Fields](/custom-fields) into logical sections. Each group can contain multiple fields and is scoped to a specific entity type (leads, deals, etc.).
