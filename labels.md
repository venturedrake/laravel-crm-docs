...
Labels provide a tagging system for categorising CRM entities. Labels use a polymorphic many-to-many relationship and can be applied to [Leads](/leads), [Deals](/deals), [People](/people), [Organisations](/organizations), and other entities. Each label has a colour (hex code) for visual identification.
