...
Addresses are polymorphic records that can belong to any addressable entity — [People](/people), [Organisations](/organizations), [Leads](/leads), [Orders](/orders), [Deliveries](/deliveries), etc. Each entity can have multiple addresses with different types (billing, shipping, primary, etc.).
