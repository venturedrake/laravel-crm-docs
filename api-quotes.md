...
| Verb | Path | Action |
|---|---|---|
| `GET` | `/api/crm/v2/quotes` | List (paginated). |
| `POST` | `/api/crm/v2/quotes` | Create. |
| `GET` | `/api/crm/v2/quotes/{uuid}` | Show. |
| `PUT` | `/api/crm/v2/quotes/{uuid}` | Update. |
| `DELETE` | `/api/crm/v2/quotes/{uuid}` | Soft-delete. |
