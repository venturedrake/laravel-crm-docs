...
| Verb | Path | Action |
|---|---|---|
| `GET` | `/api/crm/v2/invoices` | List (paginated). |
| `POST` | `/api/crm/v2/invoices` | Create. |
| `GET` | `/api/crm/v2/invoices/{uuid}` | Show. |
| `PUT` | `/api/crm/v2/invoices/{uuid}` | Update. |
| `DELETE` | `/api/crm/v2/invoices/{uuid}` | Soft-delete. |
