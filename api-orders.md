...
| Verb | Path | Action |
|---|---|---|
| `GET` | `/api/crm/v2/orders` | List (paginated). |
| `POST` | `/api/crm/v2/orders` | Create. |
| `GET` | `/api/crm/v2/orders/{uuid}` | Show. |
| `PUT` | `/api/crm/v2/orders/{uuid}` | Update. |
| `DELETE` | `/api/crm/v2/orders/{uuid}` | Soft-delete. |
